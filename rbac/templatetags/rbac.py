...
def process_menu_tree_data(request):
    ...
    # menu_list=“id  名字：保障管理  父级id“
    # menu_permission_list：id 1 名称 保障 url：www.xxxxxbbs.com   父菜单：id
    # }
    ...
    print("menu_permission_dict的列表：",menu_permission_dict)
